...
ActiveRecord::Schema.define(version: 20170517144801) do
  ...
  create_table "admin_users_pages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "page_id"
  ...
  create_table "section_edits", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id"], name: "index_section_edits_on_user_id"
  end
